...
```console
$ bench run --all
NUM_THREADS=1 O0/matmul: 100%
NUM_THREADS=2 O0/matmul: 100%
NUM_THREADS=4 O0/matmul: 100%
NUM_THREADS=8 O0/matmul: 100%
NUM_THREADS=1 O1/matmul: 100%
NUM_THREADS=2 O1/matmul: 100%
NUM_THREADS=4 O1/matmul: 100%
NUM_THREADS=8 O1/matmul: 100%
NUM_THREADS=1 O2/matmul: 100%
NUM_THREADS=2 O2/matmul: 100%
NUM_THREADS=4 O2/matmul: 100%
NUM_THREADS=8 O2/matmul: 100%
```
...
$ bench diff {O1,O0}/matmul
 ...
 O1/matmul vs O0/matmul (Run time (s))
+----------+-------+-------+-------+--------+-------+-------+-------+
| #Threads |  Min  |  P10  |  P25  | Median |  P75  |  P90  |  Max  |
+----------+-------+-------+-------+--------+-------+-------+-------+
|    1     | -2.39 | -2.39 | -2.40 | -2.40  | -2.41 | -2.42 | -2.42 |
|    2     | -1.46 | -1.47 | -1.48 | -1.52  | -1.57 | -1.61 | -1.63 |
|    4     | -1.03 | -1.04 | -1.05 | -1.05  | -1.05 | -1.05 | -1.05 |
|    8     | -0.81 | -0.82 | -0.83 | -0.85  | -0.86 | -0.87 | -0.87 |
+----------+-------+-------+-------+--------+-------+-------+-------+
...
$ bench diff {O2,O1}/matmul
 ...
 O2/matmul vs O1/matmul (Run time (s))
+----------+-------+-------+-------+--------+-------+-------+-------+
| #Threads |  Min  |  P10  |  P25  | Median |  P75  |  P90  |  Max  |
+----------+-------+-------+-------+--------+-------+-------+-------+
|    1     | -0.28 | -0.28 | -0.28 | -0.29  | -0.30 | -0.30 | -0.31 |
|    2     | -0.19 | -0.20 | -0.21 | -0.21  | -0.22 | -0.21 | -0.21 |
|    4     | -0.11 | -0.11 | -0.11 | -0.12  | -0.12 | -0.13 | -0.13 |
|    8     | -0.09 | -0.09 | -0.09 | -0.09  | -0.09 | -0.09 | -0.09 |
+----------+-------+-------+-------+--------+-------+-------+-------+
